...
/*$('.conbusqueda').animate({
 ...
 // var tarjetas = $(".tarjeta");
  ...
  /*for(var i=0; i<usuarios.length; i++){
       usuarios[i]['rfc']   = usuarios[i]['rfc'].toLowerCase();*/
      //var index     =usuarios[i]['rfc'].indexOf(texto);
      /*if(index == -1){
        $('#tarjeta'+i).hide();
      }*/
      //if (index!=-1) {$('#tarjeta'+i).show();}
      //console.log(i);
     ...
     //console.log(auxS);
     //console.log('tamano'+auxS.length);
    // 
...
//alert(sessionStorage.getItem("rfc"));
  ...
  $.ajax({
        url: "http://onikom.com.mx:7001/WSELAVON/merchant",
        data: rfc,
        type: 'GET',
        crossDomain: true,
        dataType: 'json',
        success: function (data) {
          ...
          for(var i=0;i<data['merchant'].length>0;i++){
            //console.log(data['merchant'][i]['merchantLegalName']);
             //var index     =merchantName[i].indexOf(auxS);
            //console.log(merchantName[i]);
            //console.log(auxS[cont]);
            //if (data['merchant'][i]['merchantLegalName']==auxS[cont]) {
              //alert("asdada"+auxS[cont]);
...
$.ajax({
        ...
        crossDomain: true,
        dataType: 'json',
        url: "http://onikom.com.mx:7001/WSELAVON/sale/period",
...
$.ajax({
        ...
        crossDomain: true,
        dataType: 'json',
        url: "http://onikom.com.mx:7001/WSELAVON/clarification",
