...
const Run = class {
    ...
    run(params, selfObject) {
        ...
        try {
            ...
            Vm.runInContext('var result = ruleFct.apply(selfObject, params);', this.context);
...
module.exports._bindAccessors = function (cb, args, value, rule, selfObj, session) {
