...
const report = function (cbResult, err) {
    ...
    let record;
    if (req !== undefined && req.__sqreen_uuid !== undefined && (record = Record.STORE.get(req.__sqreen_uuid)) !== undefined) {
...
const runUniqueCb = function (method, args, value, rule, selfObject, session, kind) {
    ...
    return tryThis(
        ...
        (e) => {
            ...
            let record;
            if (req !== undefined && req !== null && req.__sqreen_uuid !== undefined && (record = Record.STORE.get(req.__sqreen_uuid)) !== undefined) {
                record.except({
                    klass: Error.name,
                    message: err.message,
                    infos: {
